          ...
          <div className="navbar">
                ...
                <div tabIndex={0} role="button" className="btn btn-ghost btn-circle ">
                  ...
                  <div className='mt-1 '>
                    <ul
                      ...
                      <li className='mb-3 text-white '><NavLink className='' to='/'>Home</NavLink></li>
                      <li className='mb-3 text-white'><NavLink className='' to='/setisfied' >Satisfied</NavLink></li>
                      <li className='mb-3 text-white'><NavLink to='/DashBoard' className=''>DashBoard</NavLink></li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="navbar-center hidden md:block ">
              ...
              <div className='flex gap-5'>
                <NavLink className={({ isActive }) => `mr-4 text-xl ${isActive ? 'text-red-500 font-bold' : ''}`} to='/'>Home</NavLink>
                <NavLink className={({ isActive }) => `mr-4 text-xl ${isActive ? 'text-red-500 font-bold' : ''}`} to='/setisfied'>Setisfied</NavLink>
                <NavLink className={({ isActive }) => `mr-4 text-xl ${isActive ? 'text-red-500 font-bold' : ''}`} to='/DashBoard'>DashBoard</NavLink>
              </div>
            ...
            <div className="navbar-end">
              <button className="btn btn-ghost btn-circle">
                <GrCart className='text-3xl'></GrCart>
              </button>
              <button className="btn btn-ghost btn-circle">
